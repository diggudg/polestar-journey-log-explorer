import { Anchor, Button, Divider, Group, List, Modal, Stack, Text } from '@mantine/core';
import { IconExternalLink, IconInfoCircle } from '@tabler/icons-react';

function HelpModal({ opened, onClose }) {
  return (
    <Modal opened={opened} onClose={onClose} title="How to Use Telemetry" size="lg" centered>
      <Stack gap="md">
        <Group gap="xs">
          <IconInfoCircle size={20} />
          <Text size="sm" fw={600}>
            Getting Your Journey Data
          </Text>
        </Group>

        <Text size="sm">
          To use this explorer, you need to export your journey data from the official Polestar
          Journey Log app.
        </Text>

        <Stack gap="sm">
          <Text size="sm" fw={600}>
            Step 1: Install the Journey Log App
          </Text>
          <Text size="sm">
        ...
        <Stack gap="sm">
          <Text size="sm" fw={600}>
            Step 2: Sign In and Record Journeys
          </Text>
          <List size="sm" spacing="xs">
            ...
            <List.Item>
              Journey recording starts when you shift to drive mode and stops when parked
            </List.Item>
          </List>
        </Stack>
        ...
        <Stack gap="sm">
          ...
          <List size="sm" spacing="xs">
            ...
            <List.Item>
              Filter your journeys by date range or category (Business, Private, Commute)
            </List.Item>
        ...
        <Stack gap="xs">
          ...
          <Text size="xs" c="dimmed">
            All data processing happens locally in your browser. Your journey data never leaves your
            device. This is a community-driven tool not affiliated with Polestar.
          </Text>
        </Stack>
